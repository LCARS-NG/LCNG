<?php
// $Id: page-front-anonymous.tpl.php 126 2011-11-05 19:45:14Z giang $
...
<body id="genesis-1c" class="section-user">
    ...
    <table class="center">
      <tbody>
        <tr>
          <td class="top ibar-height"><div class="ibar1"></div> <!-- /topbar --></td>
        </tr>
        <tr>
          <td class="center">
          
           <div id="container" class="account-management" >

              <div class="columns-inner clear-block">
                <div id="content-column">
                  <div class="content-inner">
                    <?php if ($site_logo): ?><div id="logo"><?php print $site_logo; ?></div><?php endif; ?>
                    <?php if ($site_name): ?><h1 class="logo-site-name"><?php print $site_name; ?></h1><?php endif; ?>
                    <?php if ($site_slogan): ?><div id="site-slogan"><?php print $site_slogan; ?></div><?php endif; ?>
                    <div id="main-content">
                      <noscript><div class='messages error'><?php print t("This site requires Javascript.");?></div></noscript>
