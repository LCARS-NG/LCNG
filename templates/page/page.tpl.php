...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  ...
  <body id="genesis-1c" <?php print $section_class; ?>>
    <div id="container" class="<?php print $classes;?> <?php  if (function_exists('themer_body_class')) { print themer_body_class(); }?>">
      <div id="header" class="clear-block">
        <div class="lbow-topleft-positiv">
          <div class="lbow-topleft-bar">
              <h1 class="logo-site-name">
                <?php
                  ...
                  if($path[0] == 'blog' || arg(0)=='user' || arg(0)=='works')
                    {
                      $my_breadcrumb = drupal_get_breadcrumb();
                      $last_breadcrumb = $my_breadcrumb[count($my_breadcrumb)-1];
                      print '<span class="title">' . $last_breadcrumb . '</span>';
                    }
                    else
                    {
                      print '<span class="title">'.$site_name.'</span>';
                    }
                ?>
              </h1>
          </div>
      ...
      <div id="foot-wrapper" class="clear-block">
          <div class="lbow-bottomleft-positiv">
            ...
            </div> <!-- /insideframe-bottom -->
            <div class="lbow-bottomleft-bar"></div>
