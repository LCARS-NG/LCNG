<?php
// $Id: node-image.tpl.php 6 2010-10-27 16:29:16Z giang $
...
if ($logged_in) {
/*
        print $node->links[image_size__original][href];

        foreach ($node->links[image_size__original] as $i => $value) {
         print $i.'<br>';
          }
*/
